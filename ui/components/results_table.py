...
class ResultsTable(ctk.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        columns = ("pos", "description", "material", "bom_material", "order_material", "quantity", "status", "note")
    ...
    def load_data(self, table2_data):
        ...
        for item in table2_data:
            ...
            self.tree.insert("", "end",
                           values=(pos, description, material, bom_material, order_material, quantity, status, note),
                           tags=(tag,))
